...
<html>
    <head>
        ...
        <title>HANSIART ESP CAMERA</title>
        <style>
            ...
            body {font-family: Arial,Helvetica,sans-serif; background: #181818; color: #EFEFEF; font-size: 16px; text-align:center; }        
  ...
  <button id="knop" onclick= "hideDiv();">more settings</button> 
                        ...
                        <section id="buttons">
                            <table><tr>
                            <td><button value="0" id="save_set" title="Save Preferences on camera module">Save settings</button>
                            <td><button id="get-still">Get Still</button>
                            </tr><td><button id="toggle-stream">Start Stream</button>
                            <td><button id="face_enroll" class="disabled" disabled="disabled">Enroll Face</button>
     ...
     function hideDiv() {
        if (document.getElementById("knop").innerHTML=="less settings") {
         document.getElementById("more").style.display="none";
         document.getElementById("knop").innerHTML="more settings";
       } else {
         document.getElementById("more").style.display="block";
         document.getElementById("knop").innerHTML="less settings";
       }
    }
...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  var strlink = baseHost
  var streamUrl = strlink.slice(0, -1) + '1';
  const hide = el => {
  ...
  const saveButton = document.getElementById('save_set')
  const stopStream = () => {
    window.stop();
  ...
  recognize.onchange = () => {
    ...
    saveButton.onclick = () => {
      if (confirm("save the camera settings?")) {
        updateConfig(saveButton);
